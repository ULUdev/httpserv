...
#define httpserv_logging_log(msg, ...) fprintf(stderr, "[%s:%d %s] " msg "\n", __FILE__, __LINE__, httpserv_logging_get_time(), ##__VA_ARGS__);
#define httpserv_logging_wrn(msg, ...) fprintf(stderr, "[%s:%d %s] Warning: " msg "\n", __FILE__, __LINE__, httpserv_logging_get_time(), ##__VA_ARGS__);
#define httpserv_logging_err(msg, ...) fprintf(stderr, "[%s:%d %s] Error: " msg "\n", __FILE__, __LINE__, httpserv_logging_get_time(), ##__VA_ARGS__);
